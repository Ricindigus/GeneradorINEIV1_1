...
public class SQLConstantesComponente {
    ...
    public static final String[] ALL_COLUMNS_PAGINAS = {
            PAGINA_ID, PAGINA_PGHAB ,PAGINA_MODULO ,
            PAGINA_IDP1 , PAGINA_TP1 , PAGINA_PRHAB1 ,
            PAGINA_IDP2 , PAGINA_TP2 ,PAGINA_PRHAB2 ,
            PAGINA_IDP3 , PAGINA_TP3 , PAGINA_PRHAB3 ,
            PAGINA_IDP4 , PAGINA_TP4 ,PAGINA_PRHAB4 ,
            PAGINA_IDP5 , PAGINA_TP5 , PAGINA_PRHAB5 ,
            PAGINA_IDP6 , PAGINA_TP6 ,PAGINA_PRHAB6 ,
            PAGINA_IDP7 , PAGINA_TP7 , PAGINA_PRHAB7 ,
            PAGINA_IDP8 , PAGINA_TP8 ,PAGINA_PRHAB8 ,
            PAGINA_IDP9 , PAGINA_TP9 ,PAGINA_PRHAB9 ,
            PAGINA_IDP10 , PAGINA_TP10,PAGINA_PRHAB10
    };
